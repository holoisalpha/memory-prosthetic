...
export function BottomNav({ current, onNavigate }: Props) {
  ...
  return (
    <nav className="fixed bottom-4 left-4 right-4 flex justify-center pb-safe">
      <div className="bg-stone-100 rounded-[28px] shadow-xl shadow-stone-300/40 px-3 py-2 flex justify-around max-w-sm w-full border border-stone-200/50">
        {items.map(({ id, label }) => {
          ...
          return (
            <button
              ...
              `}
            >
              {isActive ? filledIcons[id] : outlinedIcons[id]}
